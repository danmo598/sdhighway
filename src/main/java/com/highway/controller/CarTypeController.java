...
public class CarTypeController {
    ...
    public Integer insertCarType(@RequestBody CarType carType) {
           return carTypeService.insertCarType(carType);
    }
    ...
    public Integer updateCarType(@RequestBody CarType carType) {
